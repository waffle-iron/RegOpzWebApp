 ...
 */
        ...
        function init_flot_chart() {
            ...
            var chart_plot_01_settings = {
                ...
                colors: [
                    "rgba(38, 185, 154, 0.38)", "rgba(3, 88, 106, 0.38)"
                ],
                xaxis: {
        ...
        function init_IonRangeSlider() {
            ...
            $("#range_27").ionRangeSlider({type: "double", min: 1000000, max: 2000000, grid: true, force_edges: true});
            ...
            $("#range_25").ionRangeSlider({type: "double", min: 1000000, max: 2000000, grid: true});
        ...
        function init_charts() {
            ...
            if ($('#canvasDoughnut').length) {
                ...
                var data = {
                    labels: [
                        "Dark Grey", "Purple Color", "Gray Color", "Green Color", "Blue Color"
                    ],
                    datasets: [
                        {
                            data: [
        ...
        function init_DataTables() {
            ...
            $('#datatable-scroller').DataTable({ajax: "js/datatables/json/scroller-demo.json", deferRender: true, scrollY: 380, scrollCollapse: true, scroller: true});
